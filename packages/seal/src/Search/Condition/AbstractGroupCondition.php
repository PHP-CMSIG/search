...
abstract class AbstractGroupCondition
{
    ...
    /**
     * @param EqualCondition|GeoBoundingBoxCondition|GeoDistanceCondition|GreaterThanCondition|GreaterThanEqualCondition|IdentifierCondition|InCondition|LessThanCondition|LessThanEqualCondition|NotEqualCondition|NotInCondition|AndCondition|OrCondition $conditions
     */
