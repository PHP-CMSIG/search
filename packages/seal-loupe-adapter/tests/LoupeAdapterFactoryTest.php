...
{
    public function testCreateHelperWithDefaultConfigurationString(): void
    {
    ...
    public function testCreateHelperWithIndexSpecificConfigurationString(): void
    {
        ...
        self::assertSame(Configuration::create()->getMaxTotalHits(), $helper->getLoupe($newsIndex)->getConfiguration()->getMaxTotalHits());
    ...
    public function testCreateHelperWithDefaultAndIndexSpecificConfigurationString(): void
    {
        $directory = \sys_get_temp_dir() . '/seal-loupe-adapter-factory-test-' . \uniqid('', true);
        \mkdir($directory, 0777, true);
    ...
    public function testCreateHelperWithNonArrayConfigurationParam(): void
    {
        $loupeAdapterFactory = new LoupeAdapterFactory();

        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('The "configuration" query param must be an array of strings');
